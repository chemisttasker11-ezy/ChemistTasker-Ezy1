...
import{categoriesForSellerContext,clampMaximumAudience,nextMarketplaceAudience,permittedBuyerRolesForCategory,permittedModesForCategory,type MarketplaceCategory,type MarketplaceListingOptions}from'@chemisttasker/shared-core';
...
export function MarketplaceParityScreen({screen}:{screen:MarketplaceScreen}){
 ...
 const[listings,setListings]=useState<any[]>([]),[listing,setListing]=useState<any>(null),[categories,setCategories]=useState<any[]>([]),[options,setOptions]=useState<MarketplaceListingOptions|null>(null),[mine,setMine]=useState<any[]>([]),[exchanges,setExchanges]=useState<any[]>([]),[exchange,setExchange]=useState<any>(null);
