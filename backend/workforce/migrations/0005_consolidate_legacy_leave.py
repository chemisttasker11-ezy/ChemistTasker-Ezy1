...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Reversing the schema would require a membership for slot-only leave.
        # Restore a database snapshot to roll this migration back safely.
        migrations.RunPython(backfill_legacy_leave),
        migrations.AddIndex(
            model_name="workforceleaverequest",
