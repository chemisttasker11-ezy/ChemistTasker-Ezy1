...
function ShiftCenterLayout({ scope, basePath, title, subtitle }: BaseProps) {
  ...
  const heroGradient = useMemo(
    () =>
      `linear-gradient(135deg, ${brandTokens.purple}, ${brandTokens.navy})`,
    []
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Box sx={{ minWidth: 0 }}>
            <Typography variant="overline" sx={{ opacity: 0.9, letterSpacing: ".1em", fontFamily: brandTokens.fontBody }}>
              Shift Centre
            </Typography>
            <Typography
              variant="h4"
              fontWeight={600}
              gutterBottom
              sx={{ fontFamily: brandTokens.fontHeading, fontSize: { xs: 30, sm: 34, md: 36 }, lineHeight: 1.2, overflowWrap: "anywhere" }}
            >
              {title}
            </Typography>
            <Typography variant="body1" sx={{ fontFamily: brandTokens.fontBody, opacity: 0.92, maxWidth: 560, fontSize: { xs: 15, sm: 16 } }}>
              {subtitle}
            </Typography>
          </Box>
        </Stack>
      ...
      >
        <Box
          component="nav"
          aria-label="Shift Centre sections"
          sx={{
            display: "grid",
            ...
            return (
              <ButtonBase
                ...
                sx={{
                  ...
                  "&:focus-visible": {
                    outline: `3px solid ${isDark ? '#C4B5FD' : brandTokens.purple}`,
                    outlineOffset: 2,
                  },
