...
import { createOwnerWorkflowTheme } from '../../../theme/ownerWorkflowTheme';
...
const PostShiftPage: React.FC<PostShiftPageProps> = ({ onCompleted }) => {
  ...
  const StepIconRoot = styled('div')<{ ownerState: { active?: boolean; completed?: boolean } }>(
    ({ theme, ownerState }) => ({
      ...
      background: ownerState.completed || ownerState.active
        ? `linear-gradient(135deg, ${brandTokens.purple} 0%, ${brandTokens.navy} 100%)`
  ...
  const eventStyleGetter = useCallback((_event: CalendarEvent, _start: Date, _end: Date, _isSelected: boolean) => {
    const backgroundColor = brandTokens.purple;
    const style = {
      backgroundColor,
      borderRadius: '6px',
      color: 'white',
        ...
        <Grid container rowSpacing={3} columnSpacing={{ xs: 0, md: 3 }}>
          <Grid size={12}>
            <FormControl fullWidth size="small" sx={fieldSx}>
              <InputLabel id="post-shift-pharmacy-label">Pharmacy *</InputLabel>
              <Select
                labelId="post-shift-pharmacy-label"
                value={pharmacyId}
                label="Pharmacy *"
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <FormControl fullWidth size="small" sx={fieldSx}>
              <InputLabel id="post-shift-role-label">Role Needed *</InputLabel>
              <Select
                labelId="post-shift-role-label"
                value={roleNeeded}
                label="Role Needed *"
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <FormControl fullWidth size="small" sx={fieldSx}>
              <InputLabel id="post-shift-employment-label">Employment Type *</InputLabel>
              <Select
                labelId="post-shift-employment-label"
                        ...
                        {category.items.map((s: any, idx: number) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <ToggleButtonGroup
                                aria-label={`${s.label} requirement`}
                                size="small"
                                value={value}
                                exclusive
                                onChange={(_, newVal) => {
                                ...
                                sx={{
                                  ...
                                  '& .Mui-selected': {
                                    ...
                                    color: value === 'required' && isDarkMode ? `${brandTokens.navy} !important` : 'white !important',
          ...
          <Grid container rowSpacing={3} columnSpacing={{ xs: 0, md: 3 }}>
            ...
            {!isEmbedded && (
              <Grid size={12}>
                <Stack spacing={2}>
                  <FormControl fullWidth size="small" sx={fieldSx}>
                    <InputLabel id="post-shift-audience-label">Initial Audience</InputLabel>
                    <Select
                      labelId="post-shift-audience-label"
                      value={visibility}
                      ...
                      return (
                        <Grid key={opt} size={{ xs: 12, md: 6, xl: 4 }}>
                          <Paper
                            ...
                            aria-label={`Start with ${ESCALATION_LABELS[opt]}`}
                            onKeyDown={(event) => {
                        ...
                        <Stack direction="row" flexWrap="wrap" justifyContent="center" gap={1}>
                          {WEEK_DAYS.map((d) => (
                            <Button
                              ...
                              aria-label={d.full}
                              aria-pressed={recurringDays.includes(d.v)}
                            >
                              {d.l}
                            </Button>
                          ))}
                        ...
                        {selectedDates.map((date) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              />
                              <IconButton
                                aria-label={`Add slot for ${formatSlotDate(date)}`}
                          ...
                          >
                            ...
                            <Stack direction="row" spacing={0.5} alignItems="center">
                              <Tooltip title="Edit slot">
                                <IconButton aria-label={`Edit slot ${index + 1}`} edge="end" onClick={() => handleEditSlot(index)} color="primary">
                                  <EditIcon />
                                </IconButton>
                              </Tooltip>
                              <Tooltip title="Delete slot">
                                <IconButton aria-label={`Delete slot ${index + 1}`} edge="end" onClick={() => setSlots(sc => sc.filter((_, idx) => idx !== index))} color="error">
                                  <DeleteIcon />
                                </IconButton>
                              </Tooltip>
                            </Stack>
            ...
            <Grid size={{ xs: 12, lg: isEmbedded ? 7.5 : 7 }} sx={{ order: { xs: 0, lg: 1 }, minWidth: 0 }}>
              <Paper
                ...
                sx={{
                  ...
                  '& .rbc-off-range': { color: 'text.secondary' },
                  '& .rbc-off-range-bg': { bgcolor: isDarkMode ? '#142036' : brandTokens.mist },
                  '& .rbc-today': { bgcolor: isDarkMode ? '#24234A' : '#EEE8FA' },
                  '& .rbc-toolbar button': {
                    color: 'text.primary',
                    minHeight: 44,
                    ...
                    '&.rbc-active, &:hover, &:focus': {
                      backgroundColor: isDarkMode ? '#24234A' : '#EEE8FA',
                      color: isDarkMode ? '#F8FAFC' : brandTokens.navy,
                    },
                  },
                  '& .rbc-toolbar': {
                    gap: 0.75,
      ...
      case 'pay': {
        ...
        const paymentField = isLocumLike ? (
          <Grid size={{ xs: 12, sm: 6 }}>
            <FormControl fullWidth size="small" sx={fieldSx}>
              <InputLabel id="post-shift-payment-label">Payment Type</InputLabel>
              <Select
                labelId="post-shift-payment-label"
          ...
          return (
            <Stack spacing={3}>
              <Grid container rowSpacing={3} columnSpacing={{ xs: 0, md: 3 }}>
                <Grid size={{ xs: 12, sm: 6 }}>
                  <FormControl fullWidth size="small" sx={fieldSx}>
                    <InputLabel id="post-shift-pay-basis-label">Pay Basis</InputLabel>
                    <Select
                      labelId="post-shift-pay-basis-label"
                      value={ftptPayMode}
                      label="Pay Basis"
          ...
          return (
            <Stack spacing={3}>
              <Grid container rowSpacing={3} columnSpacing={{ xs: 0, md: 3 }}>
                <Grid size={{ xs: 12, sm: 6 }}>
                  <FormControl fullWidth size="small" sx={fieldSx}>
                    <InputLabel id="post-shift-rate-type-label">Rate Type</InputLabel>
                    <Select
                      labelId="post-shift-rate-type-label"
                      value={rateType}
                      label="Rate Type"
            ...
            >
              ...
              <Tooltip title="View pay guide">
                <IconButton
                  ...
                  aria-label="View government award pay guide (opens in a new tab)"
                  target="_blank"
  ...
  const theme = createOwnerWorkflowTheme(mode);
  ...
  return (
    <ThemeProvider theme={theme}>
      <Container
        maxWidth={false}
        sx={{
          '& [role="button"]:focus-visible': { outline: '3px solid', outlineColor: 'primary.main', outlineOffset: 3 },
      ...
      >
        <Paper
          sx={{
            ...
            boxShadow: isEmbedded ? 'none' : '0 16px 50px rgba(6,33,74,0.06)',
        ...
        >
          ...
          >
            {steps.map((step, index) => (
              <Step key={step.label} aria-current={activeStep === index ? 'step' : undefined}>
                <StepLabel
                  StepIconComponent={StepIconComponent}
                  onClick={editingShiftId ? () => setActiveStep(index) : undefined}
                  role={editingShiftId ? 'button' : undefined}
                  tabIndex={editingShiftId ? 0 : undefined}
                  onKeyDown={editingShiftId ? (event) => {
                    if (event.key === 'Enter' || event.key === ' ') {
                      event.preventDefault();
                      event.currentTarget.click();
                    }
