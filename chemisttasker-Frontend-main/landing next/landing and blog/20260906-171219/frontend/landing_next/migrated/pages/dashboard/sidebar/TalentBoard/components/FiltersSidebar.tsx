                    ...
                    <Stack spacing={0.5} sx={{ pl: 4, pt: 0.5 }}>
                      {roleSkillOptions[role].map((skill) => (
                        <FormControlLabel
                          ...
                          label={<Typography variant="caption"><span style={{display:"inline-flex",alignItems:"center",gap:7}}><SkillIcon skill={skill}/>{skill}</span></Typography>}
                        />
                      ))}
                    </Stack>
                  </Collapse>
        ...
        <Stack spacing={0.5}>
          {softwareOptions.map((skill) => (
            <FormControlLabel
              ...
              label={<Typography variant="body2"><span style={{display:"inline-flex",alignItems:"center",gap:7}}><SkillIcon skill={skill}/>{skill}</span></Typography>}
            />
          ))}
        </Stack>
      </FilterSection>
