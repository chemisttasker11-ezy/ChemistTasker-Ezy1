...
import { useParams, useNavigate } from '@/public/navigation';
import {
  TextField,
  Button,
  Alert,
  ...
  return (
    <AuthLayout title="Set a New Password">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Button fullWidth type="submit" variant="contained" disabled={loading} sx={{ mt: 2, py: 1.5, backgroundColor: '#5222B8', '&:hover': {backgroundColor: '#00877d'} }}>
