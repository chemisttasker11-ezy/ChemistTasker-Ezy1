...
export default function Calculator(){
 ...
 <header><div className="header-inner"><a href="/" aria-label="ChemistTasker home"><img src="/assets/calculator-wordmark.png" alt="ChemistTasker" width="132" height="55"/></a><div className="header-divider"/><span className="header-label">Clinical tools</span><span className="private-badge"><LockKeyhole size={13}/> Clinical validation pending</span></div></header>
