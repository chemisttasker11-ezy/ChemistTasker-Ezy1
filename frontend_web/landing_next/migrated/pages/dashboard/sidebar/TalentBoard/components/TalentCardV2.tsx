import SkillIcon from '@/public/skill-icon';
          ...
          <Stack spacing={1} sx={{ mt: 2 }}>
            <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap">
              ...
              {candidate.clinicalServices.length > 0 ? (
                candidate.clinicalServices.map((skill) => <Chip key={skill} icon={<SkillIcon skill={skill}/>} size="small" label={skill} />)
              ) : (
                <Typography variant="caption" color="text.secondary">
                  --
                </Typography>
            ...
            <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap">
              ...
              {candidate.dispenseSoftware.length > 0 ? (
                candidate.dispenseSoftware.map((skill) => <Chip key={skill} icon={<SkillIcon skill={skill}/>} size="small" label={skill} />)
              ) : (
                <Typography variant="caption" color="text.secondary">
                  --
                </Typography>
            ...
            <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap">
              ...
              {candidate.expandedScope.length > 0 ? (
                candidate.expandedScope.map((skill) => <Chip key={skill} icon={<SkillIcon skill={skill}/>} size="small" label={skill} />)
              ) : (
                <Typography variant="caption" color="text.secondary">
                  --
                </Typography>
