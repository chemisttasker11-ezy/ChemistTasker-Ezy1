...
export default function PublicTalentBoardPage() {
  ...
  useEffect(() => {
    ...
    const image = `${origin}/assets/pharmacist-mina.jpg`;
  ...
  return (
    <>
      ...
      <AuthLayout title="Find Talent" maxWidth={false} noCard showTitle={false}>
        <TalentBoard
          publicMode={!user}
          externalPosts={user?undefined:posts}
          externalLoading={user?undefined:loading}
          externalError={user?undefined:error}
        ...
        <Dialog open={loginDialogOpen} onClose={closeLoginDialog}>
          ...
          <DialogActions>
            ...
            <Button component={RouterLink} to="/register?next=%2Ftalent%2Fpublic-board" variant="outlined">
              Create account
            </Button>
            <Button component={RouterLink} to="/login?next=%2Ftalent%2Fpublic-board" variant="contained">
              Log in
            </Button>
          </DialogActions>
        </Dialog>
