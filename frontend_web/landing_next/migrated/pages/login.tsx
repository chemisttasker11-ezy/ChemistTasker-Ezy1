...
import {returnDestination, rememberDestination, finishDestination, announceSession} from '../../shared/browser-session';
import { useEffect, useState } from 'react';
import { useNavigate, Link as RouterLink, useLocation } from '@/public/navigation';
      ...
      <AuthLayout title="Welcome Back">
        ...
        <Box mt={3}>
          <Button
            ...
            sx={{ 
              py: 1.5,
              backgroundColor: '#5222B8', // Themed button color
              '&:hover': {
        ...
        <Box mt={2} textAlign="center">
          <Link component={RouterLink} to="/password-reset" color="#5222B8">
            Forgot Password?
          </Link>
        </Box>
        ...
        <Typography variant="body2" mt={3} textAlign="center">
          ...
          <Link component={RouterLink} to="/register" fontWeight="bold" color="#5222B8">
            Register
          </Link>
        </Typography>
        ...
        <Typography variant="caption" mt={2} display="block" textAlign="center" color="text.secondary">
          ...
          <Link component={RouterLink} to="/terms-of-service" color="#5222B8">
            Terms of Service
          </Link>{" "}
          and{" "}
          <Link component={RouterLink} to="/privacy-policy" color="#5222B8">
            Privacy Policy
          </Link>
          .
        </Typography>
