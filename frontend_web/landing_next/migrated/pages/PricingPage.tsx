                ...
                <Container maxWidth="xl">
                    <Toolbar disableGutters sx={{ justifyContent: 'space-between' }}>
                        <a href="/" style={{ display: 'flex', alignItems: 'center' }}>
                            <img src={logoBanner.src} alt="ChemistTaskerRx Logo" style={{ height: '48px', width: 'auto' }} />
                        </a>
                        <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' }, justifyContent: 'flex-end', alignItems: 'center', gap: 4 }}>
                            ...
                            {user ? (
                                ...
                                <>
                                    ...
                                    <CtaButton href={user?'/dashboard':PAGE_ROUTES.register} variant="contained" size="small" sx={{ px: 2.5, py: 1 }}>Sign Up</CtaButton>
                                </>
                            )}
                        </Box>
                ...
                <Box sx={{ py: 8, bgcolor: 'transparent' }}>
                    <Container maxWidth="lg">
                        <Grid container spacing={4} justifyContent="center" alignItems="stretch">
                                ...
                                <PricingCard>
                                    <CardContent sx={{ p: { xs: 4, md: 5 } }}>
                                        ...
                                        <Button
                                            ...
                                            color="primary"
                                            fullWidth
                                            href={user?'/dashboard':PAGE_ROUTES.register}
                            ...
                            {/* Subscriber Pro */}
                            <Grid size={{ xs: 12, md: 4 }}>
                                <PricingCard sx={{ border: '2px solid #5222B8' }}>
                                    {/* Badge */}
                                    <Box sx={{
