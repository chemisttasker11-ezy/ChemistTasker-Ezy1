...
export default function LandingPage() {
  ...
  return <>
    ...
    <main id="main">
      <section className="hero"><div className="container hero-grid"><div className="hero-copy"><p className="eyebrow"><span className="live-dot"/> BUILT FOR THE PEOPLE BEHIND THE COUNTER</p><h1>Locum shifts.<br/>Pharmacy teams.<br/><span>Better together.</span></h1><p className="hero-description">Find pharmacy work, discover talent and keep availability, teams and everyday workforce admin connected in one pharmacy-focused platform.</p><div className="button-row"><LinkButton path={href('/shifts/public-board')}>Find a Shift</LinkButton><LinkButton path={href('/talent/public-board')} secondary>Find Talent</LinkButton></div><div className="hero-personas" aria-label="ChemistTasker personas"><span data-persona="owner"><i/>Owner</span><span data-persona="pharmacist"><i/>Pharmacist</span><span data-persona="other-staff"><i/>Other staff</span><span data-persona="explorer"><i/>Explorer</span></div><a className="hero-calculator" href="/calculator" aria-label="Open children's dose calculator"><span className="hero-calculator-icon"><MeasuringCylinder/></span><span className="hero-calculator-copy"><span className="hero-calculator-kicker">CLINICAL UTILITY</span><strong>Children’s dose calculator</strong><span>Oral anti-infectives · Source-linked doses</span></span><ArrowUpRight size={18} aria-hidden="true"/></a></div>
      <div className="hero-visual"><div className="photo-main"><img src="/assets/pharmacist-priya.jpg" alt="Pharmacy professional in a bright community pharmacy" fetchPriority="high"/><span className="photo-caption"><span className="tiny-dot"/> People at the heart of pharmacy.</span></div><div className="photo-small"><img src="/assets/pharmacist-david.jpg" alt="Pharmacist in a community pharmacy"/></div><div className="floating-card"><span className="icon-box cyan"><CalendarCheck size={23}/></span><div><strong>A good day starts here.</strong><span>Your team. Your schedule. Connected.</span></div><CheckCheck size={21} className="teal"/></div><div className="orbit-stamp"><Users size={20}/><span>MADE FOR<br/>YOUR TEAM</span></div></div></div>
