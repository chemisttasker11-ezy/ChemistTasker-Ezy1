...
import {
  type Pharmacy,
  type WorkerSwapRequest,
  type Assignment,
  type OpenShift,
  mapPharmacySummaryToView,
  mapAssignmentToView,
  mapOpenShiftToView,
  mapWorkerRequestToView,
  ROLES,
  ALL_STAFF,
  LEAVE_TYPES,
} from './RosterWorkerPage.model';
import RosterWorkerDialogs from './RosterWorkerDialogs';
  ...
  return (
    <Box sx={{ width: '100%', minWidth: 0 }}>
      ...
      <RosterWorkerDialogs
        ...
        isSwapDialogOpen={isSwapDialogOpen}
        setIsSwapDialogOpen={setIsSwapDialogOpen}
        canModifySwapRequest={canModifySwapRequest}
        handleCancelSwapRequest={handleCancelSwapRequest}
        handleSubmitSwapRequest={handleSubmitSwapRequest}
        isClaimShiftDialogOpen={isClaimShiftDialogOpen}
        setIsClaimShiftDialogOpen={setIsClaimShiftDialogOpen}
        isSubmitting={isSubmitting}
        handleClaimShift={handleClaimShift}
      />
