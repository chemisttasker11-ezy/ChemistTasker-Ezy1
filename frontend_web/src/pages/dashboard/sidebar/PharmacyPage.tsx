...
export default function PharmacyPage({
  ...
  return (
    <Box sx={{ flex: 1, minHeight: 0, width: "100%", color: DASHBOARD_INK, fontFamily: DASHBOARD_FONT_FAMILY }}>
      ...
      <PharmacyClaimsPanels
        view={view}
        isOrganizationUser={isOrganizationUser}
        standalone={standalone}
        claimedPharmacyCount={claimedPharmacyCount}
        claimAccordionOpen={claimAccordionOpen}
        setClaimAccordionOpen={setClaimAccordionOpen}
        ...
        ownerAccordionOpen={ownerAccordionOpen}
        setOwnerAccordionOpen={setOwnerAccordionOpen}
        ...
        openOwnerClaimDialog={openOwnerClaimDialog}
      />
