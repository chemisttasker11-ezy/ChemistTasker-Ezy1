...
| Memberships/pharmacies | `client-profile/memberships/**`, `my-memberships/**`, `membership-invite-links/**`, `membership-applications/**`, `magic/memberships/**` | `backend/client_profile/urls.py` | Membership/invite/application operations in `api.ts` | Shared | Copied/migrated consumers | Shared | `SHARED` | Includes magic-link public apply flow. |
